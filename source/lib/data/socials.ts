...
export const linkedIn = {
  href: "https://www.linkedin.com/in/carloseduardomatte/",
  i18nKey: "linkedIn",
...
/** My GitHub profile. */
export const github = {
  href: "https://github.com/CarlosEduardoMatte",
  i18nKey: "github",
...
/** My online resume. */
export const resume = {
  href: "https://drive.google.com/file/d/1A_ejC43UZzJp_r0IYZG0pupE0kRToWRF/view?usp=drive_link",
  i18nKey: "resume",
...
/** My email address. */
export const email = {
  href: "mailto:carloseduardomatte656@gmail.com",
  i18nKey: "email",
  iconKey: "lucide:mail",
} as const satisfies SocialData;
